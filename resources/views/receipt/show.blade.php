...
<div class="col-lg-12">
    <div class="block">
        <div class="title"><strong>In Phiếu</strong></div>
                ...
                <div id="printJS-form">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Kiểu Phiếu</label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label class="col-md-8 control-label" for="selectbasic">Thuế
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-md-5">
                                    <label class="col-md-9 control-label" for="selectbasic">Tổng Tiền</label>
...
<button type="button" class="btn btn-primary" style="height:41px ; width:101px ;margin-left: -16px; margin-top: 33px;"
    onclick="printData()">In Phiếu</button>
@endsection
